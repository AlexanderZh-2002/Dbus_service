...
class basic_json
{
  ...
  public:
    ...
    */
        ...
        : m_type(value_t::array)
    {
        using std::begin;
        using std::end;
        m_value.marray = create<array_t>(begin(val), end(val));
    }
    ...
    */
               ...
               value_t manual_type = value_t::array)
    {
        ...
        else
        {
            ...
            m_type = value_t::array;
            m_value.marray = create<array_t>(std::move(init));
        }
    }
    ...
    */
    basic_json(size_type cnt, const basic_json& val)
        : m_type(value_t::array)
    {
        m_value.marray = create<array_t>(cnt, val);
    }
    ...
    */
    ...
    basic_json(InputIT first, InputIT last) : m_type(first.m_object->m_type)
    {
        ...
        switch (m_type)
        {
            ...
            case value_t::array:
            {
                m_value.marray = create<array_t>(first.m_it.array_iterator, last.m_it.array_iterator);
                break;
            }
    ...
    */
        ...
        : m_type(other.m_type)
    {
        switch (m_type)
        {
            ...
            case value_t::array:
            {
                assert(other.m_value.marray != nullptr);
                m_value = *other.m_value.marray;
                break;
            }
    ...
    ~basic_json()
    {
        switch (m_type)
        {
            ...
            case value_t::array:
            {
                ...
                alloc.destroy(m_value.marray);
                alloc.deallocate(m_value.marray, 1);
                break;
            }
  ...
  private:
    ...
    T get_impl(T*) const
    {
        ...
        {
            T to_vector;
            assert(m_value.marray != nullptr);
            std::transform(m_value.marray->begin(), m_value.marray->end(),
    ...
    std::vector<T> get_impl(std::vector<T>*) const
    {
        if (is_array())
        {
            ...
            assert(m_value.marray != nullptr);
            to_vector.reserve(m_value.marray->size());
            std::transform(m_value.marray->begin(), m_value.marray->end(),
                           std::inserter(to_vector, to_vector.end()), [](basic_json i)
            {
                return i.get<T>();
    ...
    T get_impl(T*) const
    {
        ...
        {
            assert(m_value.marray != nullptr);
            return T(m_value.marray->begin(), m_value.marray->end());
        }
        else
        {
            throw std::domain_error("type must be array, but is " + type_name());
    ...
    {
        return is_array() ? m_value.marray : nullptr;
    }
    ...
    */
    reference operator[](size_type idx)
    {
        ...
        if (is_array())
        {
            ...
            assert(m_value.marray != nullptr);
            for (size_t i = m_value.marray->size(); i <= idx; ++i)
            {
                m_value.marray->push_back(basic_json());
            }

            return m_value.marray->operator[](idx);
        }
        else
        {
    ...
    */
    ...
    InteratorType erase(InteratorType pos)
    {
        ...
        switch (m_type)
        {
            ...
            {
                assert(m_value.marray != nullptr);
                result.m_it.array_iterator = m_value.marray->erase(pos.m_it.array_iterator);
                break;
            }
    ...
    */
    ...
    InteratorType erase(InteratorType first, InteratorType last)
    {
        ...
        switch (m_type)
        {
            ...
            {
                assert(m_value.marray != nullptr);
                result.m_it.array_iterator = m_value.marray->erase(first.m_it.array_iterator,
    ...
    */
    void erase(const size_type idx)
    {
        ...
        if (is_array())
        {
            ...
            assert(m_value.marray != nullptr);
            m_value.marray->erase(m_value.marray->begin() + static_cast<difference_type>(idx));
        }
        else
        {
            throw std::domain_error("cannot use erase() with " + type_name());
  ...
  public:
    ...
    */
    size_type max_size() const noexcept
    {
        switch (m_type)
        {
            ...
            {
                assert(m_value.marray != nullptr);
                return m_value.marray->max_size();
            }
    ...
    */
    void push_back(basic_json&& val)
    {
        ...
        assert(m_value.marray != nullptr);
        m_value.marray->push_back(std::move(val));
        // invalidate object
    ...
    */
    iterator insert(const_iterator pos, const basic_json& val)
    {
        ...
        if (is_array())
        {
            ...
            iterator result(this);
            assert(m_value.marray != nullptr);
            result.m_it.array_iterator = m_value.marray->insert(pos.m_it.array_iterator, val);
            return result;
        }
        else
        {
    ...
    */
    iterator insert(const_iterator pos, size_type cnt, const basic_json& val)
    {
        ...
        if (is_array())
        {
            ...
            iterator result(this);
            assert(m_value.marray != nullptr);
            result.m_it.array_iterator = m_value.marray->insert(pos.m_it.array_iterator, cnt, val);
            return result;
        }
        else
        {
    ...
    */
    iterator insert(const_iterator pos, const_iterator first, const_iterator last)
    {
        ...
        iterator result(this);
        assert(m_value.marray != nullptr);
        result.m_it.array_iterator = m_value.marray->insert(
    ...
    */
    iterator insert(const_iterator pos, std::initializer_list<basic_json> ilist)
    {
        ...
        iterator result(this);
        assert(m_value.marray != nullptr);
        result.m_it.array_iterator = m_value.marray->insert(pos.m_it.array_iterator, ilist);
        return result;
    }
    ...
    friend bool operator==(const_reference lhs, const_reference rhs) noexcept
    {
        ...
        if (lhs_type == rhs_type)
        {
            switch (lhs_type)
            {
                case value_t::array:
                {
                    assert(lhs.m_value.marray != nullptr);
                    assert(rhs.m_value.marray != nullptr);
                    return *lhs.m_value.marray == *rhs.m_value.marray;
                }
                case value_t::object:
                {
              ...
              const unsigned int current_indent = 0) const
    {
        ...
        switch (m_type)
        {
            ...
            case value_t::array:
            {
                ...
                for (auto i = m_value.marray->cbegin(); i != m_value.marray->cend(); ++i)
                {
                    if (i != m_value.marray->cbegin())
                    {
                        o << (pretty_print ? ",\n" : ",");
                    }
                    o << string_t(new_indent, ' ');
      ...
      private:
        ...
        void set_begin()
        {
            ...
            switch (m_object->m_type)
            {
                ...
                case basic_json::value_t::array:
                {
                    assert(m_object->m_value.marray != nullptr);
                    m_it.array_iterator = m_object->m_value.marray->begin();
                    break;
                }
        ...
        void set_end()
        {
            ...
            switch (m_object->m_type)
            {
                ...
                {
                    assert(m_object->m_value.marray != nullptr);
                    m_it.array_iterator = m_object->m_value.marray->end();
                    break;
                }
      ...
      public:
        ...
        reference operator*() const
        {
            ...
            switch (m_object->m_type)
            {
                ...
                case basic_json::value_t::array:
                {
                    assert(m_object->m_value.marray);
                    assert(m_it.array_iterator != m_object->m_value.marray->end());
