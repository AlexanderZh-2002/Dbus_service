В данном репозитории представлена реализация Dbus сервиса на языке C++, написанная с использованием библиотеки sdbus-c++. Для сборки требуется sdbus-c++ версии 2.1.0.
